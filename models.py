...
class Yolov4(object):
    ...
    def predict_video(self, video_path, random_color=True, plot_img=True, figsize=(10, 10), show_text=True):
        ...
        # self.predict_img(frame, random_color, plot_img, figsize, show_text)
